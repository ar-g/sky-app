...
* Your solution looks like the provided in the `/designs/results.png` file.
...
We've provided a design for phone layout (see `/designs/results.png`). Don't worry about tackling tablet screens.
...
The Android project that you create should be put into the app folder (you can use Java or Kotlin too).
...
* Please exclude generated files from your submission. When we review your code it will be built in Android Studio. Please use a stable, non-beta version of Android Studio for the development.
